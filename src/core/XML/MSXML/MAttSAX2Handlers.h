...
#ifndef __MATTSAX2HANDLERS_H
#define __MATTSAX2HANDLERS_H

#include "../XMLAttValidation.h"
#include "../XMLAttHandlers.h"

#include "MAttValidator.h"
...
//  -----------------------------------------------------------------------
class MAttSAX2ErrorHandler: public ISAXErrorHandler
{
public:
  ...
  // Standard functions
  MAttSAX2ErrorHandler();
  virtual ~MAttSAX2ErrorHandler();
...
//  -----------------------------------------------------------------------
class MAttSAX2ContentHandler: public ISAXContentHandler, public XMLAttHandlers
{
public:
  // Standard functions
  MAttSAX2ContentHandler();
  virtual ~MAttSAX2ContentHandler();
...
private:
  // Local variables
  MAttValidator *m_pValidator;

  // REQUIRED variable
  ULONG m_refCnt;
};

#endif /*  __MATTSAX2HANDLERS_H */
