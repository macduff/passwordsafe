...
#ifndef __EATTXMLPROCESSOR_H
#define __EATTXMLPROCESSOR_H
...
class EAttXMLProcessor
{
public:
  EAttXMLProcessor(PWScore *pcore, UUIDVector *pPossible_Aliases, 
