...
enum XTR_Codes {
  ...
  XTR_BOOLEANYESNORULE    = 0x1000,
  XTR_BOOLEANSETRULE      = 0x0800,
  XTR_DATERULE            = 0x0400,
  XTR_ENTRYRULE           = 0x0200,
  XTR_INTEGERRULE         = 0x0100,
  XTR_PASSWORDRULE        = 0x0080,
  XTR_PASSWORDHISTORYRULE = 0x0040,
  XTR_PASSWORDPOLICYRULE  = 0x0020,
  XTR_STRINGRULE          = 0x0010,
  XTR_STRINGPRESENTRULE   = 0x0008,
  XTR_DCARULE             = 0x0004,
  XTR_STATUSRULE          = 0x0002,
  XTR_SIZERULE            = 0x0001,

  XTR_BOOLEANONLY = (XTR_BOOLEANACTIVERULE | XTR_BOOLEANPRESENTRULE | 
                       XTR_BOOLEANYESNORULE | XTR_BOOLEANSETRULE),
};
