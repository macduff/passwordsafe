...
/////////////////////////////////////////////////////////////////////////////
// CExportAttDlg dialog


CExportAttDlg::CExportAttDlg(CWnd* pParent, ATFVector &vatf)
  : CPWDialog(CExportAttDlg::IDD, pParent),
  m_vatf(vatf), m_pVKeyBoardDlg(NULL), m_pctlPasskey(NULL)
{
  m_passkey = L"";
...
void CExportAttDlg::DoDataExchange(CDataExchange* pDX)
{
  CPWDialog::DoDataExchange(pDX);

  //{{AFX_DATA_MAP(CExportAttDlg)
...
BEGIN_MESSAGE_MAP(CExportAttDlg, CPWDialog)
  //{{AFX_MSG_MAP(CExportAttDlg)
...
/////////////////////////////////////////////////////////////////////////////
// CExportAttDlg message handlers

void CExportAttDlg::OnHelp()
{
  CString cs_HelpTopic;
  cs_HelpTopic = app.GetHelpFileName() + L"::/html/export_attachments.html";
  HtmlHelp(DWORD_PTR((LPCWSTR)cs_HelpTopic), HH_DISPLAY_TOPIC);
}

void CExportAttDlg::OnOK() 
{
...
void CExportAttDlg::OnAdvanced()
{
  CAdvancedAttDlg Adv((CWnd *)this, m_vatf);

  Adv.DoModal();
}

void CExportAttDlg::OnVirtualKeyboard()
{
...
LRESULT CExportAttDlg::OnInsertBuffer(WPARAM, LPARAM)
{
