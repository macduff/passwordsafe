...
#if _MSC_VER >= 1400
    _itot_s(m_nColumnTypeByIndex[i], buffer, 8, 10);
    _itot_s(m_nColumnWidthByIndex[i], widths, 8, 10);
#else
    _itot(m_nColumnTypeByIndex[i], buffer, 10);
    _itot(m_nColumnWidthByIndex[i], widths, 10);
#endif
    cs_columns += buffer;
